...
struct TCPoint
{
    ...
    float x = 0, y = 0, phi = 0, t = 0, dist = 0, v = 0, w = 0;
};
 ...
 *       to the path simulation time steps.
 *
 */
class DiffDriveCollisionGridBased : public mrpt::nav::CPTG_RobotShape_Polygonal
{
   public:
    ...
    class CCollisionGrid : public mrpt::containers::CDynamicGrid<TCollisionCell>
    {
       ...
       public:
        CCollisionGrid(
            ...
            float resolution, DiffDriveCollisionGridBased* parent)
...
MRPT_DECLARE_TTYPENAME_NAMESPACE(TCPoint, selfdriving::ptg)
}  // namespace mrpt::typemeta
